...
genop_ega_basic_program()
{
    ...
    add_panpipe_process "index_norm_bam"        "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_ega_norm_bam"
    add_panpipe_process "index_tum_bam"         "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_ega_tum_bam"
