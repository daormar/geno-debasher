...
genodb_ega_asp_basic_program()
{
    ...
    add_debasher_process "index_norm_bam"            "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_ega_asp_norm_bam"
    add_debasher_process "index_tum_bam"             "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_ega_asp_tum_bam"
