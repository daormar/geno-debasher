...
genodb.index_norm_bam_define_opts()
{
    ...
    # -normalbam option
    define_opt_from_proc_out "-normalbam" "genodb.download_aws_norm_bam" "-out-nb" optlist || return 1
...
genodb.index_tum_bam_define_opts()
{
    ...
    # -tumorbam option
    define_opt_from_proc_out "-tumorbam" "genodb.download_aws_tum_bam" "-out-tb" optlist || return 1
...
{
    add_debasher_process "genodb.download_aws_norm_bam" "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
    add_debasher_process "genodb.download_aws_tum_bam"  "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
