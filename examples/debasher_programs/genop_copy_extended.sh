...
genop_copy_extended_program()
{
    ...
    add_panpipe_process "bedtools_genomecov_norm_bam" "cpus=1  mem=2G      time=5:00:00"
    add_panpipe_process "bedtools_genomecov_tum_bam"  "cpus=1  mem=2G      time=5:00:00"
    add_panpipe_process "create_genref_for_bam"       "cpus=1  mem=8G      time=4:00:00"
    add_panpipe_process "parallel_split_norm_bam"     "cpus=1  mem=2G      time=5:00:00,10:00:00  throttle=16"
    add_panpipe_process "parallel_split_tum_bam"      "cpus=1  mem=2G      time=5:00:00,10:00:00  throttle=16"
    add_panpipe_process "parallel_samtools_mpileup_norm_bam" "cpus=1  mem=4G  time=8:00:00,16:00:00 throttle=24"
    add_panpipe_process "parallel_samtools_mpileup_tum_bam"  "cpus=1  mem=4G  time=8:00:00,16:00:00 throttle=24"
    add_panpipe_process "gen_sequenza_gcc"            "cpus=1  mem=1G      time=01:00:00"
    add_panpipe_process "parallel_bam2seqz"           "cpus=1  mem=2G      time=5:00:00  throttle=16"
    add_panpipe_process "seqzmerge_plus_sequenza"     "cpus=1  mem=10G     time=5:00:00,10:00:00"
    add_panpipe_process "parallel_delly"              "cpus=1  mem=10G,30G time=5:00:00  throttle=16"
    add_panpipe_process "parallel_lumpy"              "cpus=2  mem=10G,30G time=5:00:00,10:00:00  throttle=16"
    add_panpipe_process "parallel_svtyper"            "cpus=1  mem=8G,16G  time=6:00:00,24:00:00  throttle=16"
