...
print_desc()
{
    echo "genodb_download_gdc_metadata downloads gdc metadata given a manifest file"
    echo "type \"genodb_download_gdc_metadata --help\" to get usage information"
}

########
usage()
{
    echo "genodb_download_gdc_metadata  -m <string> [--help]"
    echo ""
