...
genop_tcga_xgs_program()
{
    ...
    add_debasher_process "msisensor"                   "cpus=2  mem=8G      time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam,afterok:index_norm_bam,afterok:index_tum_bam"
