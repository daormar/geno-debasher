...
genop_tcga_xgs_program()
{
    ...
    add_panpipe_process "create_genref_for_bam"       "cpus=1  mem=8G      time=4:00:00"           "processdeps=afterok:download_gdc_norm_bam"
    add_panpipe_process "bedtools_genomecov_norm_bam" "cpus=1  mem=1024    time=4:00:00"           "processdeps=afterok:index_norm_bam"
    add_panpipe_process "bedtools_genomecov_tum_bam"  "cpus=1  mem=1024    time=4:00:00"           "processdeps=afterok:index_tum_bam"
    ...
    add_panpipe_process "msisensor"                   "cpus=2  mem=8G      time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam,afterok:index_norm_bam,afterok:index_tum_bam"
    add_panpipe_process "snp_pileup_plus_facets"      "cpus=1  mem=8G      time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam,afterok:index_norm_bam,afterok:index_tum_bam"
