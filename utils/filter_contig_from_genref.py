...
def take_pars():
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "g:r:k:l:", [
                                   "genref=", "contigrem=", "contigkeep", "listc="])
...
def print_help():
    print(
        "filter_contig_from_genref -g <string> {-r <string> | -k <string> | -l <string>}", file=sys.stderr)
