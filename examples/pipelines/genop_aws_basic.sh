...
genop_aws_basic_pipeline()
{
    add_panpipe_process "download_aws_norm_bam" "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
    add_panpipe_process "download_aws_tum_bam"  "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
    add_panpipe_process "index_norm_bam"        "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_aws_norm_bam"
    add_panpipe_process "index_tum_bam"         "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:download_aws_tum_bam"
