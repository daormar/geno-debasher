...
genodb_ega_asp_extended_program()
{
    add_debasher_process "download_ega_asp_norm_bam" "cpus=1  mem=2048    time=24:00:00" "processdeps=none"
    add_debasher_process "download_ega_asp_tum_bam"  "cpus=1  mem=2048    time=24:00:00" "processdeps=none"
    add_debasher_process "index_norm_bam"            "cpus=1  mem=1024    time=4:00:00"  "processdeps=afterok:download_ega_asp_norm_bam"
    add_debasher_process "index_tum_bam"             "cpus=1  mem=1024    time=4:00:00"  "processdeps=afterok:download_ega_asp_tum_bam"
    ...
    add_debasher_process "msisensor"                 "cpus=2  mem=10G,20G time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam,afterok:index_norm_bam,afterok:index_tum_bam"
