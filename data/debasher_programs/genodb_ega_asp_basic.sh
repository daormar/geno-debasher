...
index_norm_bam_define_opts()
{
    ...
    # -normalbam option
    define_opt_from_proc_out "-normalbam" "download_ega_asp_norm_bam" "-out-nb" optlist || return 1
...
index_tum_bam_define_opts()
{
    ...
    # -tumorbam option
    define_opt_from_proc_out "-tumorbam" "download_ega_asp_tum_bam" "-out-tb" optlist || return 1
...
{
    add_debasher_process "download_ega_asp_norm_bam" "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
    add_debasher_process "download_ega_asp_tum_bam"  "cpus=1  mem=2048 time=48:00:00" "processdeps=none"
    ...
    add_debasher_process "manta_somatic"             "cpus=2  mem=8G   time=48:00:00"
    add_debasher_process "strelka_somatic"           "cpus=2  mem=4096 time=48:00:00"
    add_debasher_process "msisensor_pro"             "cpus=2  mem=10G  time=48:00:00"
    add_debasher_process "clear_datadir"             "cpus=1  mem=1024 time=48:00:00" "processdeps=afterok:manta_somatic,afterok:strelka_somatic,afterok:msisensor_pro"
}
