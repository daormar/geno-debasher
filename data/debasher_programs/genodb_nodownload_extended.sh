...
genodb_nodownload_extended_program()
{
    ...
    add_debasher_process "genodb.parallel_split_norm_bam"   "cpus=1  mem=2G      time=5:00:00,10:00:00  throttle=16" "processdeps=none"
    add_debasher_process "genodb.parallel_split_tum_bam"    "cpus=1  mem=2G      time=5:00:00,10:00:00  throttle=16" "processdeps=none"
    add_debasher_process "genodb.parallel_samtools_mpileup_norm_bam" "cpus=1  mem=4G  time=8:00:00,16:00:00 throttle=24" "processdeps=aftercorr:genodb.parallel_split_norm_bam"
    add_debasher_process "genodb.parallel_samtools_mpileup_tum_bam"  "cpus=1  mem=4G  time=8:00:00,16:00:00 throttle=24" "processdeps=aftercorr:genodb.parallel_split_tum_bam"
    add_debasher_process "genodb.gen_sequenza_gcc"          "cpus=1  mem=1G      time=1:00:00"
    add_debasher_process "genodb.parallel_bam2seqz"         "cpus=1  mem=2G      time=5:00:00  throttle=16" "processdeps=afterok:genodb.gen_sequenza_gcc,aftercorr:genodb.parallel_samtools_mpileup_norm_bam,aftercorr:genodb.parallel_samtools_mpileup_tum_bam"
    add_debasher_process "genodb.seqzmerge_plus_sequenza"   "cpus=1  mem=10G     time=5:00:00,10:00:00"  "processdeps=afterok:genodb.parallel_bam2seqz"
    add_debasher_process "genodb.parallel_delly"            "cpus=1  mem=10G,30G time=5:00:00  throttle=16" "processdeps=aftercorr:genodb.parallel_split_norm_bam,aftercorr:genodb.parallel_split_tum_bam"
    add_debasher_process "genodb.parallel_lumpy"            "cpus=2  mem=10G,30G time=5:00:00,10:00:00  throttle=16" "processdeps=aftercorr:genodb.parallel_split_norm_bam,aftercorr:genodb.parallel_split_tum_bam"
    add_debasher_process "genodb.parallel_svtyper"          "cpus=1  mem=8G,16G  time=6:00:00,24:00:00  throttle=16" "processdeps=aftercorr:genodb.parallel_lumpy"
