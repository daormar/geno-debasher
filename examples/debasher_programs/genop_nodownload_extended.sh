...
genop_nodownload_extended_program()
{
    ...
    add_panpipe_process "parallel_split_tum_bam"    "cpus=1  mem=2G      time=5:00:00,10:00:00  throttle=16" "processdeps=none"
    ...
    add_panpipe_process "gen_sequenza_gcc"          "cpus=1  mem=1G      time=1:00:00"  "processdeps=afterok:create_genref_for_bam"
    ...
    add_panpipe_process "msisensor"                 "cpus=2  mem=10G,20G time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam"
    add_panpipe_process "snp_pileup_plus_facets"    "cpus=1  mem=25G     time=8:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam"
    add_panpipe_process "cnvkit"                    "cpus=8  mem=30G     time=6:00:00,24:00:00"  "processdeps=afterok:create_genref_for_bam"
