...
usage()
{
    ...
    echo "                       NOTES:"
    echo "                       - The contig name can also specify its length"
    echo "                       (contigname_length) so as to refine the mapping when"
    echo "                       a contig has been defined with multiple lengths"
